...
var HabitController = /** @class */ (function () {
    ...
    HabitController.prototype.createHabit = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, name, frequency, startDate, time, userService;
            return __generator(this, function (_b) {
                _a = req.body, email = _a.email, name = _a.name, frequency = _a.frequency, startDate = _a.startDate, time = _a.time;
